#!/usr/bin/env bash
# One-time VM setup for Relay on Debian 12 / Ubuntu 24.04
# Run as root: sudo bash vm-setup.sh
set -euo pipefail

REPO_URL="https://github.com/Shamiivan/relay.git"
APP_USER="relay"
...
echo "  2. Run: sudo -u $APP_USER pm2 restart relay-bot"
echo "  3. Check logs: sudo -u $APP_USER pm2 logs relay-bot"
echo "============================================"
