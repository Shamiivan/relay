...
```bash
printf '{"campaignId":"019c0e38-c5be-70d5-b730-fdd27bea4548","leads":[{"email":"ada@example.com","firstName":"Ada"}]}' | company/workflows/sales_prospect_research/tools/instantly.lead.add/run
```
